...
## About Me
My name is Logan Bronstein. I'm the founder of Sale Advisor — a professional sales service where we come to your house, go through everything you want sold, list it across every marketplace, handle delivery through our moving company, sell it, and get you paid. We just take a percentage of the sale price (not including delivery). No upfront cost to the client. Pricing varies depending on the item sold.

I'm also VP of Lakeshore Hauling LLC — a moving and junk removal company started by my best friend and co-founder Keller Westman about 4 years ago in Chicago. We expanded it by having college friends open locations across the country — Denver CO, Knoxville TN, Columbus OH, across Wisconsin, East Lansing MI, and Champaign IL. Lakeshore Hauling handles all delivery for Sale Advisor buyers.

Sale Advisor is launching soon (target: within 1 month, as of March 2026), starting in Chicago, with plans to go national. Keller is out of town for the next few weeks so we can't do in-person estimates yet — this window is being used to get the backend, ads, and marketing fully ready for launch. The vision is simple: everybody has things in their house they'd love to sell but are too lazy to deal with. That's where we come in. From furniture to handbags to cars — there is nothing we won't sell.
...
- **Brody Bronstein** — Logan's brother, co-founder of B² (BSquared) Marketing Agency. Will handle filming and running ads for Sale Advisor.
...
## My Audience
Literally everyone. Every single demographic — college kids, young adults, parents, grandparents, all of them. I have different ad creatives planned to target each group specifically. Higher ticket items are preferred because we take a percentage, but I don't want anyone feeling like their stuff isn't worth selling with us. Nobody gets turned away.

## My Voice & Style
I'm incredibly personable. Customer service is everything — Lakeshore Hauling has a 5-star Google review and anything below that is not an option.

With clients: I'm casual, funny, borderline unprofessional at times — I want them to feel like they're talking to a friend, not just the "guy selling their stuff." I read the room. Some clients want to chat about their day, others just want the quote. I adjust.

With business partners and other professionals: I'm extremely professional, polished, and to the point. No fluff.

I have a strong understanding of sales psychology — especially in marketing. I know what to say and what to put in an ad to stop the scroll. My goal is to be the company people recommend to their friends because we're easy to work with, reliable, and deliver five-star service every time.

Written communication: casual over text for logistics, specific and polished when it's time for quotes or anything of substance.
...
2. Clicks a link that takes them directly to text us (they communicate via text message)
3. OR they visit saleadvisor.com and submit an inquiry
4. We respond and communicate from our CRM dashboard (not personal phones)
5. Schedule an in-person estimate — we go to their house and catalog everything they want to sell
6. We list items across all marketplaces
7. We sell, handle delivery via Lakeshore Hauling, and pay the client

## Tools I Use
- **Marketing:** Facebook Groups (free, works incredibly well), Meta Ads, Google Ads, TikTok, Nextdoor, Twitter — every platform possible
- **Marketplaces:** Facebook Marketplace, eBay, Craigslist — and eventually our own Sale Advisor app/marketplace
...
Logan cannot read code. Everything needs to be explained in plain English. When building something, give a brief explanation of what's happening so he has a clear picture — but if he already understands, he may just say "go ahead" and skip the explanation.

## Current Focus (Sale Advisor)
...
4. **Unified CRM / communications hub** — a fully working dashboard that:
   ...
   - Pulls in every lead and CTA from every platform
   - Shows which platform each lead came from
   - Displays all ad analytics in one place
   - Handles everything else we need a CRM for
5. **Sale Advisor app** — a full marketplace where buyers can purchase items we're selling for our clients. Planned for later once we've built up a big enough client base for it to make sense.
